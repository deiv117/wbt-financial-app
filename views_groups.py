...
from database_groups import (
    ...
    add_external_member, settle_external_debt_admin, settle_debt_to_external, add_shared_expense 
)
            ...
            for g in gastos:
                ...
                with st.container(border=True):
                    ...
                    with col1:
                        ...
                        pagador = nombres.get(g['paid_by'], 'Alguien')
